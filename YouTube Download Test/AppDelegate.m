...
{
//    QTMovie *movie = [[QTMovie alloc] initWithFile:@"/Users/Lasse/Desktop/Film.mov" error:nil];
...
//    [urlDownload ]
    QTMovie *movie = [[QTMovie alloc] initWithURL:[NSURL URLWithString:url] error:nil];
